package com.samiun.businesskitchen.ui.screens.miscscreen
...
@Composable
fun MiscScreen(navController: NavController, sharedViewModel: SharedViewModel) {
    val misc = sharedViewModel.getItems()?.data?.miscItems
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = {
                    Text(
                        "Misc", color = MaterialTheme.colorScheme.onPrimary
                    )
                }
            )
        },
